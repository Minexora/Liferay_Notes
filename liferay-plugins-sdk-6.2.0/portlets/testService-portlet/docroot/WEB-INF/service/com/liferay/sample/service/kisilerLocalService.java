...
/**
 * Provides the local service interface for kisiler. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author giray
 * @see kisilerLocalServiceUtil
...
public interface kisilerLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link kisilerLocalServiceUtil} to access the kisiler local service. Add custom service methods to {@link com.liferay.sample.service.impl.kisilerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
